...
const DoublePara = () => {
  return (
    <div className="flex flex-col items-center justify-center space-y-12 bg-[#f9f9fb] px-4 py-[85px] text-left text-[#020617] lg:py-[105px] lg:text-center">
      <p
        className={` ${MonaRegular.className} text-md max-w-[815px] text-[1.125rem] font-normal leading-[2.2rem] lg:text-[1.3rem] lg:leading-[2.75rem]`}
      >
