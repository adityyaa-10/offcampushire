...
const SignupPage = () => {
  ...
  return (
    <div className="relative mx-auto h-full w-full">
      ...
      />
      <div className="absolute inset-0 top-8 mx-auto w-full pb-40 sm:top-24 lg:top-36">
        <div className="mx-auto flex w-full max-w-[1400px] flex-col gap-y-12 px-4">
          <div className="flex w-full flex-col items-start justify-between gap-6 sm:px-10 lg:flex-row xl:px-20">
            ...
            <div className="flex w-full flex-col items-center justify-center lg:w-1/2">
              <div
                className="flex h-64 w-full items-center justify-center rounded-t-[20px] bg-[#9540F2] text-center text-4xl text-white sm:h-56 sm:w-[400px]"
