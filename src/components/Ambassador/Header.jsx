          ...
          <div className="flex w-full flex-col gap-4 sm:w-fit sm:flex-row sm:gap-2">
            <button className="w-full sm:w-fit">
              <div className="focus:shadow-purple group relative h-full w-full rounded-lg transition-all focus:outline-none sm:w-fit">
                <span
                  className={`font-button-size-200 flex h-full flex-row items-center justify-center gap-2 rounded-lg bg-gray-950 px-4 py-3 text-white transition-all hover:bg-gray-700 focus:bg-gray-950 active:bg-gray-800 ${GeneralMedium.className}`}
                >
