...
const Header = () => {
  return (
    <section className="relative flex justify-center">
      <div className="relative z-10 flex flex-col items-center py-24 xl:max-w-[1170px]">
        <div className="z-50">
          <h1
      ...
      <img
        className="absolute bottom-0 right-0 z-0 h-[200px] w-full object-cover md:h-[300px]"
