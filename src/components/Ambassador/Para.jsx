...
const Para = () => {
  return (
    <div className="space-y-2 px-4 py-12 text-left md:space-y-6 md:text-center lg:py-28">
      ...
      <p
        className={`mx-auto max-w-[730px] text-left text-[18.5px] leading-[2.4rem] tracking-[0.01em] text-[#6D7C92] md:text-center lg:text-[20px] lg:leading-[2.75rem] ${GeneralMedium.className}`}
      >
